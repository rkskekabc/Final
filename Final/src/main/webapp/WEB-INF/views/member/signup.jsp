	...
	<div class="col-md-4">
		<form action="/member/doSignup" method="post" class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="text" name="m_name" class="form-control" style="width: 80%" placeholder="이름"/>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="inputName" class="col-md-3 control-label">비밀번호 확인</label>
				<div class="col-md-9">
					<input type="password" name="m_pw2" class="form-control" style="width: 80%" placeholder="비밀번호 확인"/>
				</div>
			</div>
			<br/>
			<div class="col-md-3"></div>
			<div class="col-md-9">
				<input type="submit" value="회원가입" class="btn btn-success btn-lg" style="width: 80%"/>
			</div>
		</form>
	</div>
	<div class="col-md-4"></div>
