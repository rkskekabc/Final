...
<div class="row">
	  ...
	  <div class="col-md-2" style="background-color: #eeeeee; padding-top:1%; padding-bottom: 20%">
		  <ul class="nav nav-pills nav-stacked" role="tablist">
		    <li role="presentation"><a href="/member/mypage" aria-controls="mypage" role="tab"><span style="color: #aaaaaa; font-size: medium">내 정보</span></a></li>
		    <li role="presentation" class="active"><a href="/member/mygroup" aria-controls="mygroup" role="tab"><span style="font-size: medium">내 동아리</span></a></li>
